...
if task == "Sentiment Classification":
    ...
    if new_review_text.strip():
        ...
        if model_option == "Perceptron":
            with open(r"C:\Users\shifa\OneDrive\Desktop\DL Prediction\Deep-Prediction-Hub\Percep.pkl", 'rb') as file:
                model = pickle.load(file)
        elif model_option == "Backpropagation":
            with open(r"C:\Users\shifa\OneDrive\Desktop\DL Prediction\Deep-Prediction-Hub\backpropagation.pkl", 'rb') as file:
                model = pickle.load(file)
        elif model_option == "DNN":
            model = load_model(r"C:\Users\shifa\OneDrive\Desktop\DL Prediction\Deep-Prediction-Hub\DeepLearning.keras")
        elif model_option == "RNN":
            model = load_model(r"C:\Users\shifa\OneDrive\Desktop\DL Prediction\Deep-Prediction-Hub\RN.keras")
        elif model_option == "LSTM":
            model = load_model(r"C:\Users\shifa\OneDrive\Desktop\DL Prediction\Deep-Prediction-Hub\LS.keras")
    ...
    if uploaded_file is not None:
        ...
        model = load_model(r"C:\Users\shifa\OneDrive\Desktop\DL Prediction\Deep-Prediction-Hub\CNN\CN.keras")
